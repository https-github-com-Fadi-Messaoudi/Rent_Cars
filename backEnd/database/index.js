...
const searchProduct=(query,callback)=>{
    
    const sql=`SELECT * FROM product WHERE name LIKE (?) OR category LIKE (?)`
...
module.exports= { getAllProducts, postall,deletone,putone,searchProduct };